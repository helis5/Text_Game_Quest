    ...
    public static class AnalyzeTheEnvironment
    {
        ...
        public static void Look_for_geometric_anomalies()
        {
            if (State.Awareness >= 25)
            {
                ...
                GoodChange.Print(@"Эффект: ""Войдя в узкий переулок, вы видите, что стены двух зданий не сходятся, образуя едва заметный «шов», за которым пустота и мерцание кода."" *О +20, С -10 (шокирующее зрелище), Э -15.*");
            ...
            else
            {
                ...
                BadChange.Print("Вам пока рано сюда, вы недостаточно осознали сущность происходящего. Вы ничего не нашли, но привлеки внимание. Ск - 5");
                State.Stealth -= 5;
                State.Display();
